...
Echo * Na minha maquina as vezes o CleanMGR trava, se passou muito tempo eu abro o gerenciador de tarefas (para abrir o gerenciador precione CTRL + SHIFT + ESC), botaão direito nele na guia detalhes e finalizo a arvore
